          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-4xl md:text-6xl font-bold tracking-wide mb-4">
                Watermark & Detect AI Images with <span className='text-blue-600'>Mark</span><span className='text-white'>AI</span>
              </h1>
            ...
            <div className="hidden md:block">
              <img src="/assets/images/CAT.jpg" alt="AI Image Generation Concept" className="rounded-3xl shadow-xl" />
            </div>
          </div>
        </div>
      </section>
